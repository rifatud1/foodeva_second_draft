...
class Registration extends StatelessWidget {
  ...
  final LoginRegistrationController _loginRegistraionController = Get.find();
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children:  [
                            ...
                            Text('FoodEva', style: const TextStyle(
                                fontSize: 48, color: Colors.white,fontWeight: FontWeight.w800,fontFamily: 'Raleway-bold'
                            ),),
                          ],
                        ),
                              ...
                              Obx(()=>TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  IconButton(
                                    ...
                                    icon: const Icon(Icons.visibility_off) ,color: primaryColor,) :
                                  IconButton(
                                    onPressed: (){
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  onTap: () async {
                                    ...
                                    //   });
                                    //   _loginRegistraionController.loggedInDrawer.value = 1;
                                    //   _loginRegistraionController.loggedOutDrawer.value = 0;
                                    ...
                                    //   Get.back();
                                    //   await _loginRegistraionController.getTheOTP(
                                    //       mobileNumber: _mobileNumberTextEditingController.value.text
                                    //   );
                                    //   Get.offAll(OtpPage(mobileNumber: _mobileNumberTextEditingController.value.text,));
                                  ...
                                  child: Container(
                                    ...
                                    child:  Padding(
                                      ...
                                      child: Center(
                                        child: Text('Sign Up'.tr,textAlign: TextAlign.center,
